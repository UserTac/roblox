...
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/UserTac/roblox/main/randomlib"))() -- not my lib

menu = library.new('<font color="rgb(0,0,139)">melvin</font>.vip', "novasaves\\")
local tabs = {
